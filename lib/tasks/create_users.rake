namespace :db do
  ...
  task create_sample_user: :environment do
    ...
    User.create!(fname: "Matt",
                 lname: "Higbee",
                 preferred_name: "Matt",
                 email: "matt.higbee@kkr.com",
                 password: "kkrssg",
                 password_confirmation: "kkrssg",
                 password_changed: false,
                 firm_name: "KKR & Co.",
                 short_firm_name: "KKR",
                 office_city: "New York, NY",
                 email_verified: false)
    User.create!(fname: "Matthew",
                 lname: "Higbee",
                 preferred_name: "Matthew",
                 email: "matthew.higbee@kkr.com",
                 password: "kkrssg",
                 password_confirmation: "kkrssg",
                 password_changed: false,
                 firm_name: "KKR & Co.",
    ...
    User.create!(fname: "Timothy",
                 ...
                 office_city: "New York City",
                 email_verified: false)
    User.create!(fname: "Jonathan",
                 lname: "Vaughan",
                 preferred_name: "Jonathan",
                 email: "jonathan.vaughan@blackstone.com",
                 password: "bxtrial",
                 password_confirmation: "bxtrial",
                 password_changed: false,
                 firm_name: "Blackstone",
                 short_firm_name: "Blackstone",
                 office_city: "New York City",
